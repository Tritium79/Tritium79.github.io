...
- 文章文件夹名是否符合 slug 规则（普通词汇首字母大写、连字符分隔、无非法字符；专有名词/品牌名/特殊大小写保留官方写法）？
...
- HTML 中是否暴露了个人信息、密码、API密钥 等敏感信息？
  - 例外：`pages/deme.html`（及 `en/pages/deme.html`）中主动写出的联系方式（如邮箱、社交账号）属于站点主人有意公开的内容，**不算暴露隐私**，无需报告或修改。
- 使用exiftool检查图片元数据中是否可能包含 GPS 位置等隐私信息？
